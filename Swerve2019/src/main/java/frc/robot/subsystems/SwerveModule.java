...
public class SwerveModule {
 // private final Spark m_driveMotor_old;
 // private final Spark m_turningMotor_old;
 ...
 // private final Encoder m_turningEncoder;
  ...
  public SwerveModule(
    ...
    this.m_turningEncoder = new AnalogEncoder(turningEncoderPorts[0]);
  ...
  public SwerveModuleState getState() {
    System.out.println("getState(): driveEncoderVelocity: " + m_driveEncoder.getVelocity() + ", turningEncoderGet: " + m_turningEncoder.get() );
